...
namespace Простое_расписние.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Speciality,Info")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Speciality,Info")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
