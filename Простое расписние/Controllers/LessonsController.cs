...
namespace Простое_расписние.Controllers
{
    public class LessonsController : Controller
    {
        ...
        public LessonsController(Простое_расписниеContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Speciality,Year")] Lesson lesson)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Speciality,Year")] Lesson lesson)
        {
            if (id != lesson.Id)
            {
                return NotFound();
